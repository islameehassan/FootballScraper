...
def parseRequest():
    ...
    parse.add_argument("--fbd", default=0, type=int, help="number of days to go frowards or backwards from the date provided, such that negative numbers will go backwards")
